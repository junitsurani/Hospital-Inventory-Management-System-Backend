...
router.post("/api/receipt/delete-row", editInfoFields, receiptController.deleteRow);
...
router.post("/api/vouchers/delete-row", editInfoFields, voucherController.deleteRow);
